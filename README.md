...
| `BACKTRACE_MIN_SIZE` | `1024` when peak recording is on, else `0` | Skip stack capture for allocations smaller than this. This is the main cost control: in a typical pipeline it filters >99% of allocations. |
